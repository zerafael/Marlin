...
#define CUSTOM_MACHINE_NAME "Ender 3 S1 PRO - UBL"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.7286
    #define DEFAULT_Ki  1.8150
    #define DEFAULT_Kd  53.6101
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 96.2304
  #define DEFAULT_bedKi 17.9534
  #define DEFAULT_bedKd 343.8633
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 422.8}
